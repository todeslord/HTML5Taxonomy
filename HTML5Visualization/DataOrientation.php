...
<script language="javascript" type="text/javascript" src="DataOrientation.js"></script>


</head>

<body onload="init('orientation');">
...
We sorted the features according to be their main aspect from our point of view.
The data-category includes all features regarding the storing, tagging and standardization of data.<br />
The features giving an audio-visual output to the user are represented by the <b>visualization-category</b>.
