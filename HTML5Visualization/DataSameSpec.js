...
"children" : [{
		...
		"children" : [{
			...
			"id" : "HTML5/yes/Web Storage",
			"name" : "Web Storage"
		}],
		"data" : {
			"description" : "W3C and WhatWg specifications are the same.",
			"shortDescription" : "",
			"$angularWidth" : 0,
			"$color" : "#17F2DC",
			"feature" : "false",
		...
		"children" : [{
			...
			"id" : "HTML5/nearly/Microdata",
			"name" : "Microdata"
		}],
		"data" : {
			"description" : "W3C and WhatWg specifications are nearly the same. e.g. one has extra colums.",
			"shortDescription" : "",
			"$angularWidth" : 0,
			"$color" : "#B8C21D",
			"feature" : "false",
		...
		"children" : [{
			...
			"id" : "HTML5/no/Wai-Aria",
			"name" : "Wai-Aria"
		}],
		"data" : {
			"description" : "WhatWg specification is only use-oriented. W3C specification covers all aspects.",
			"shortDescription" : "",
			"$angularWidth" : 0,
			"$color" : "#23A80C",
			"feature" : "false",
		...
		"children" : [{
			...
			"id" : "HTML5/only W3C/Contacts API",
			"name" : "Contacts API"
		},{
			...
			"id" : "HTML5/only W3C/Touch Events",
			"name" : "Touch Events"
		},{
			...
			"id" : "HTML5/only W3C/CCXML",
			"name" : "CCXML"
		}],
		"data" : {
			"description" : "Only W3C is specifying this feature.",
			"shortDescription" : "is specifying",
			"$angularWidth" : 0,
			"$color" : "#DBABEA",
			"feature" : "false",
			"longName" : "only W3C"
