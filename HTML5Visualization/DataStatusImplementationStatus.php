...
<script language="javascript" type="text/javascript" src="DataStatusImplementationStatus.js"></script>


</head>

<body onload="init('statusImplementationStatus');">
...
This View combines W3C-Status in the inner circle and ImplementationStatus (WhatWg) in the outer circle.<br/>
The idea is to point out where the development is concurrent and where not.		
