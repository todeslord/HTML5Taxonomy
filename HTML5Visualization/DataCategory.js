...
"children" : [{
		...
		"children" : [{
			...
			"id" : "HTML5/communication/Web-Sockets",
			"name" : "Web-Sockets"
		},{
			...
			"id" : "HTML5/communication/Ajax",
			"name" : "Ajax"
		}],
		"data" : {
			"description" : "All features covering interaction between different programming-languages via web.",
			"shortDescription" : "within the programming-language",
			"$angularWidth" : 0,
			"$color" : "#C37B2B",
			"feature" : "false",
			"longName" : "communication"
		},
		"id" : "HTML5/communication",
		"name" : "communication"
	},{
		...
		"children" : [{
			...
			"id" : "HTML5/access/CCXML",
			"name" : "CCXML"
		}],
		"data" : {
			"description" : "All features allowing user-input.",
		...
		"children" : [{
			...
			"id" : "HTML5/data/Contacts API",
			"name" : "Contacts API"
		}],
		"data" : {
			"description" : "All features regarding the storing, tagging and standardization of data. ",
			"shortDescription" : "storage, library, tagging, collection",
			"$angularWidth" : 0,
			"$color" : "#9DBB80",
			"feature" : "false",
			"longName" : "data"
		...
		"children" : [{
			...
			"id" : "HTML5/parallelization/Web Workers",
			"name" : "Web Workers"
		}],
		"data" : {
			"description" : "All features running processes in the background without interfering with the user-interface.",
			"shortDescription" : "generate background processes",
			"$angularWidth" : 0,
			"$color" : "#1D9644",
			"feature" : "false",
			"longName" : "parallelization"
		},
		"id" : "HTML5/parallelization",
		...
		"children" : [{
			...
			"id" : "HTML5/visualization/Audio Element",
			"name" : "Audio Element"
		},{
			...
			"id" : "HTML5/visualization/Video Element",
			"name" : "Video Element"
		},{
			...
			"id" : "HTML5/visualization/Canvas Element",
			"name" : "Canvas Element"
		},{
			...
			"id" : "HTML5/visualization/SVG",
			"name" : "SVG"
		}],
		"data" : {
			"description" : "All features giving an audio-visual output to the user.",
			"shortDescription" : "output",
			"$angularWidth" : 0,
			"$color" : "#556F93",
			"feature" : "false",
			"longName" : "visualization"
		},
		"id" : "HTML5/visualization",
		"name" : "visualization"
	}],
	"data" : {
		"$type" : "none"
